...
const SECURITY_ITEMS = [
  ...
  { icon: "fingerprint",    label: "Autenticación de Dos Factores" },
  { icon: "visibility_off", label: "Privacidad de Perfil" },
];
    ...
    <>
      ...
      <section className="flex flex-col items-center text-center space-y-4 mb-10 max-w-2xl mx-auto">
        <div className="relative group">
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-surface-container-lowest shadow-sm bg-surface-container-low flex items-center justify-center">
            {user.avatarUrl ? (
        ...
        <div>
          ...
          <p className="text-secondary font-medium">Especialista en Fisiatría</p>
        </div>
      </section>
      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        <section className="space-y-4">
          <h2 className="text-xs font-bold uppercase tracking-[0.2em] text-slate-400 px-1">
        ...
        <section className="space-y-4">
          ...
          <div className="bg-surface-container-lowest rounded-2xl overflow-hidden divide-y divide-surface-container">
            <ToggleSwitch
              icon="notifications"
              iconVariant="primary"
              label="Notificaciones de nuevos resúmenes"
              description="Alertas instantáneas de contenido nuevo"
              checked={notifNew}
            ...
            <ToggleSwitch
              ...
              description="Compendio de investigaciones destacadas"
              checked={notifEmail}
        ...
        <section className="space-y-4">
          ...
          <div className="bg-surface-container-lowest rounded-2xl overflow-hidden">
            {SECURITY_ITEMS.map(({ icon, label }, i) => (
              <div key={label}>
